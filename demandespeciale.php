...
<html lang="en">
  ...
  <head>
    ...
    <title>Bar Retro 50 & Dalton</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="index.html">Retro 50 & Dalton</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.html">Retour au Retro 50</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="https://www.facebook.com/pg/barretro50/events/?ref=page_internal">Événements</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-bottom" id="mainNav">
      <div class="container">
        ...
        <a class="btn btn-xl" href="demandespeciale.html">Demande Spéciale</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Demande Spéciale</h2>
            <h3 class="section-subheading text-muted">En Live au DJ !</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright bg-light">Copyright &copy; Groupe Process3 2017</span>
          </div>
